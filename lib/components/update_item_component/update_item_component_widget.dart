...
import 'update_item_component_model.dart';
export 'update_item_component_model.dart';

class UpdateItemComponentWidget extends StatefulWidget {
  const UpdateItemComponentWidget({
    super.key,
    required this.id,
  ...
  @override
  State<UpdateItemComponentWidget> createState() =>
      _UpdateItemComponentWidgetState();
}

class _UpdateItemComponentWidgetState extends State<UpdateItemComponentWidget> {
  late UpdateItemComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateItemComponentModel());
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            FFButtonWidget(
              onPressed: () async {
                _model.apiResult733 = await UpdateitemAPICall.call(
