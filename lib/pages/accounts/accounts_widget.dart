...
class _AccountsWidgetState extends State<AccountsWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: GetuserinfoAPICall.call(),
      builder: (context, snapshot) {
        ...
        final accountsGetuserinfoAPIResponse = snapshot.data!;
            ...
            child: Column(
              ...
              children: [
                Builder(
                  builder: (context) {
                    final accountList =
                        accountsGetuserinfoAPIResponse.jsonBody.toList();
