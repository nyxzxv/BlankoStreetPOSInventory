...
class _PaymentsPageWidgetState extends State<PaymentsPageWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: GetposAPICall.call(
        transactionId: widget.transacId,
      ),
      builder: (context, snapshot) {
        ...
        final paymentsPageGetposAPIResponse = snapshot.data!;
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.amountReceivedTextController,
                                    focusNode: _model.amountReceivedFocusNode,
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.paymentMethodsValueController ??=
                                          FormFieldController<String>(
                                    _model.paymentMethodsValue ??= 'Cash',
                                  ),
                                  options: ['Cash', 'Gcash'],
                                  onChanged: (val) => safeSetState(
                                      () => _model.paymentMethodsValue = val),
                                  width: 370.0,
                                  height: 52.0,
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: ((_model.amountReceivedTextController
                                                  .text ==
                                              '') ||
                                      (_model.paymentMethodsValue == null ||
                                          _model.paymentMethodsValue == ''))
                                  ? null
                                  : () async {
                                      _model.paid =
                                          await ConfirmposAPICall.call(
                                        pAmountReceived: int.tryParse(_model
                                            .amountReceivedTextController.text),
                                        pPaymentMethod:
                                            _model.paymentMethodsValue,
                                        pTransactionId: widget.transacId,
                                      );

                                      if ((_model.paid?.succeeded ?? true)) {
                              ...
                              options: FFButtonOptions(
                                ...
                                borderRadius: BorderRadius.circular(12.0),
                                disabledColor: Color(0x506F4C3E),
                              ),
                            ),
                          ),
                        ),
